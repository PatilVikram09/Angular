...
export class ProductService{
    ...
    postData(prd:Product):Observable<Response>{
       ...
       // header.append("AUTHORIZATION","Basic vikram:vikram123");
    ...
    serchData(searchValue:any):Observable<Response>{
        let resp:Observable<Response>;

        resp = this.http.get(`${this.url}/api/productsSearch/${searchValue}`);
        return resp;
    }
}